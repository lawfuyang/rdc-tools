...
// --------------------------------------------------------------------------- schema
//: The schemas themselves live in schema.cpp/schema.h, with the reasoning: they are data, and they were
//: the largest single block in this file. What follows prints them, writes them and checks them, and is
//: here because it reports through `Fail` and the run log like every other command.
